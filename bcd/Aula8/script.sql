...
create procedure insere_pedidos()
    ...
    start transaction;
        insert into Pedidos(cliente_id, data, hora) values(27,DATE_SUB(curdate(),INTERVAL 10 DAY),"18:54:00");
        insert into Itens_Pedido(pedido_id, pizza_id, quantidade, valor) values(27,2,1, (select valor from Pizzas where pizza_id = 2));
        insert into Itens_Pedido(pedido_id, pizza_id, quantidade, valor) values(27,4,2, (select valor from Pizzas where pizza_id = 4));
        insert into Itens_Pedido(pedido_id, pizza_id, quantidade, valor) values(27,6,3, (select valor from Pizzas where pizza_id = 6));
